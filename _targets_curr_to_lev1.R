...
list(
  ...
  tar_target(
    v_fname_mm,
    get_logger_filenames(fname_pattern = "*Metmast_MainMet_30min*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_mm,
    process_logger_files(v_fname = v_fname_mm,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L04_F01,
    get_logger_filenames(fname_pattern = "*_L04_F01*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L04_F01,
    process_logger_files(v_fname = v_fname_L04_F01,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L04_F02,
    get_logger_filenames(fname_pattern = "*_L04_F02*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L04_F02,
    process_logger_files(v_fname = v_fname_L04_F02,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L04_F04,
    get_logger_filenames(fname_pattern = "*_L04_F04*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L04_F04,
    process_logger_files(v_fname = v_fname_L04_F04,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L04_F05,
    get_logger_filenames(fname_pattern = "*_L04_F05*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L04_F05,
    process_logger_files(v_fname = v_fname_L04_F05,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L02_F01,
    get_logger_filenames(fname_pattern = "*_L02_F01*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L02_F01,
    process_logger_files(v_fname = v_fname_L02_F01,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L03_F01,
    get_logger_filenames(fname_pattern = "*_L03_F01*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L03_F01,
    process_logger_files(v_fname = v_fname_L03_F01,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L03_F02,
    get_logger_filenames(fname_pattern = "*_L03_F02*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L03_F02,
    process_logger_files(v_fname = v_fname_L03_F02,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    v_fname_L05_F01,
    get_logger_filenames(fname_pattern = "*_L05_F01*",
      dir_in = dir_in
    ), format = "file"
  ),
  tar_target(
    dt_L05_F01,
    process_logger_files(v_fname = v_fname_L05_F01,
      start.date = paste0(this_year, "-01-01 00:00:00")
    )
  ),
  tar_target(
    l_dt,
    list(
      dt_mm, dt_L04_F01, dt_L04_F02, dt_L04_F04, dt_L04_F05,
  ...
  tar_target(
    v_fname_lev1,
    subset_by_year(l_lev1_curr, dir_out = dir_out,
