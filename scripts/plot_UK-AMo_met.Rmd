...
system.time(
  render("plot_UK-AMo_met.Rmd",
    ...
    params = list(
      n_days = 7,
      dir_out_mainmet = "/gws/nopw/j04/ukem/public/UK-AMo/30min",
      rewrite_rules = FALSE,
...
knitr::purl("plot_UK-AMo_met.Rmd")
...
subset_data <- function(df, last_date_to_process, n_days = 7){
  # date specified without time assumed to be 00:00 midnight
  # we want the end of this day, so add 24 h
  last_date_to_process <- last_date_to_process + lubridate::days(1)
  # first_date <- last_date_to_process - (n_days * 24*60*60)
  first_date <- last_date_to_process - lubridate::days(n_days)
...
# standardise names
standardise_names <- function(df, allow_duplicates = FALSE) {

  # remove standard deviations columns - no need for these
  sd_cols <- str_detect(names(df), "_Std")
  df <- df[, !sd_cols]

  # remove columns marked for deletion - usually duplicates after merging
  del_cols <- str_detect(names(df), "_delete_me")
  df <- df[, !del_cols]
  ...
  names(df) <- str_replace(names(df), "A_tot_NRT_Tot", "A_tot_NRT_12_1_1_Tot")
  names(df) <- str_replace(names(df), "P_TB_Tot", "P_13_1_2_Tot")

  # find duplicate cols and remove
  if (any(duplicated(names(df))) & !allow_duplicates) {
...
#### 0a. Main Met Mast 30-min data - previous data
fname_in <- "Metmast_MainMet_30min_20230111.dat"
df <- read_data(dir_in, fname_in)
df <- subset_data(df, last_date_to_process, n_days)
df <- standardise_names(df)
df_main <- df

#### 0b. Main Met Mast 30-min data - previous data
fname_in <- "Metmast_MainMet_30min_20231208.dat"
df <- read_data(dir_in, fname_in)
df <- subset_data(df, last_date_to_process, n_days)
df <- standardise_names(df)
# combine completed and current data
df_main <- plyr::rbind.fill(df_main, df)

#### 0c. Main Met Mast 30-min data - previous data
fname_in <- "Metmast_MainMet_1min_2025_01_06.dat"
df <- read_data(dir_in, fname_in)
df <- subset_data(df, last_date_to_process, n_days)
df <- standardise_names(df)
# combine archived and current data
df_main <- plyr::rbind.fill(df_main, df)
...
# "TA_2_1_1"    "TA_IU_2_1_1" "RH_2_1_1"    "RH_IU_2_1_1" "date"
fname_in <- "UK-AMo_BM_L02_F01_timechecked.dat"
...
#  "P_12_1_1"        "D_SNOW_4_1_1"    "D_SNOW_IU_4_1_1" "date"
fname_in <- "UK-AMo_BM_L03_F02_timechecked.dat"
...
df_main <- merge(df_main, df, by = "date", suffixes = c("","_delete_me"))

#### 4.      UK-AMo_BM_L04_F01 data
 # [1] "TS_8_1_1"      "TS_8_2_1"      "TS_8_3_1"      "TS_8_4_1"
 # [5] "TS_8_5_1"      "TS_9_1_1"      "TS_9_2_1"      "TS_9_3_1"
 # [9] "TS_9_4_1"      "TS_9_5_1"      "G_8_1_1"       "G_IU_8_1_1"
# [13] "G_SF_8_1_1"    "G_ISCAL_8_1_1" "G_9_1_1"       "G_IU_9_1_1"
# [17] "G_SF_9_1_1"    "G_ISCAL_9_1_1" "WTD_8_1_1"     "WCP_8_1_1"
# [21] "WTD_IU_8_1_1"  "WTD_9_1_1"     "WCP_9_1_1"     "WTD_IU_9_1_1"
# [25] "SWC_8_1_1"     "SWC_8_2_1"     "SWC_8_3_1"     "SWC_8_4_1"
# [29] "SWC_IU_8_1_1"  "SWC_IU_8_2_1"  "SWC_IU_8_3_1"  "SWC_IU_8_4_1"
# [33] "SWC_9_1_1"     "SWC_9_2_1"     "SWC_9_3_1"     "SWC_9_4_1"
# [37] "SWC_IU_9_1_1"  "SWC_IU_9_2_1"  "SWC_IU_9_3_1"  "SWC_IU_9_4_1"
# [41] "date"
fname_in <- "UK-AMo_BM_L04_F01_timechecked.dat"

df <- read_data(dir_in, fname_in)
# TODO: this causes an error because only two lines in file
df <- subset_data(df, last_date_to_process, n_days)
df <- timeAverage(df, avg.time = "30 min", start.date = first_date)
df_main <- merge(df_main, df, by = "date")
...
# "SW_IN_7_1_1"    "SW_IN_IU_7_1_1" "date"
fname_in <- "UK-AMo_BM_L04_F02_timechecked.dat"
...
#### 6.      UK-AMo_BM_L04_F05 data
# [1] "TA_7_1_1"    "TA_IU_7_1_1" "RH_7_1_1"    "RH_IU_7_1_1" "WD_7_1_1"
# [6] "WS_7_1_1"    "date"
fname_in <- "UK-AMo_BM_L04_F05_timechecked.dat"
...
# "P_13_1_1" "date"
fname_in <- "UK-AMo_BM_L04_F04_timechecked.dat"
...
#### 8.      UK-AMo_BM_L05_F01 data
 # [1] "TS_10_1_1"      "TS_10_2_1"      "TS_10_3_1"      "TS_10_4_1"
 # [5] "TS_10_5_1"      "TS_11_1_1"      "TS_11_2_1"      "TS_11_3_1"
 # [9] "TS_11_4_1"      "TS_11_5_1"      "G_10_1_1"       "G_IU_10_1_1"
# [13] "G_SF_10_1_1"    "G_ISCAL_10_1_1" "G_11_1_1"       "G_IU_11_1_1"
# [17] "G_SF_11_1_1"    "G_ISCAL_11_1_1" "WTD_10_1_1"     "WCP_10_1_1"
# [21] "WTD_IU_10_1_1"  "WTD_11_1_1"     "WCP_11_1_1"     "WTD_IU_11_1_1"
# [25] "SWC_10_1_1"     "SWC_10_2_1"     "SWC_10_3_1"     "SWC_10_4_1"
# [29] "SWC_IU_10_1_1"  "SWC_IU_10_2_1"  "SWC_IU_10_3_1"  "SWC_IU_10_4_1"
# [33] "SWC_11_1_1"     "SWC_11_2_1"     "SWC_11_3_1"     "SWC_11_4_1"
# [37] "SWC_IU_11_1_1"  "SWC_IU_11_2_1"  "SWC_IU_11_3_1"  "SWC_IU_11_4_1"
# [41] "date"
fname_in <- "UK-AMo_BM_L05_F01_timechecked.dat"
...
# TODO: do we need this now program has changed?
# # soil heat flux
...
df$G <- rowMeans(data.frame(df$G_4_1_1, df$G_10_1_1, df$G_11_1_1), na.rm = TRUE)
...
Data from the past week  is available [here](https://gws-access.jasmin.ac.uk/public/ukem/UK-AMo/plot_UK-AMo_week.html).

Data from the past month is available [here](https://gws-access.jasmin.ac.uk/public/ukem/UK-AMo/plot_UK-AMo_month.html).

Data from the past year  is available [here](https://gws-access.jasmin.ac.uk/public/ukem/UK-AMo/plot_UK-AMo_year.html).

<!--- { create_rules -->
```{r create_rules, eval=params$rewrite_rules, echo=FALSE, warning=FALSE, message=FALSE}
...
v_names_to_plot = c("P_12_1_1", "P_13_1_1")
...
# Reading in the ICOS variable names ----
df_range <- read_excel("variable_ranges.xlsx", sheet = "rules")
df_range <- subset(df_range, !is.na(min))
v_icos_names <- unique(df_range$symbol)
# we do not want to keep the soil heat flux sensitivity factor
...
# Reading in the rules for variable ranges ----
rule_range <- readRDS(file = "rules_amo_mainmet.rds")
...
# TODO: removing this now program has changed
# df$G <- rowMeans(data.frame(df$G_4_1_1, df$G_4_1_2))
...
l_lev1 <- impute(y = "SW_IN", l_met = l_lev1, method = "time", k = 20,  qc_toleave = c(0, 4), plot_graph = plot_graph)
l_lev1 <- impute(y = "SW_OUT", l_met = l_lev1, method = "time", k = 20, qc_toleave = c(0, 4), plot_graph = plot_graph)
...
l_lev1 <- impute(y = "PPFD_IN_4_1_1", l_met = l_lev1, method = "time", k = 20, qc_toleave = c(0, 4), plot_graph = plot_graph)
l_lev1 <- impute(y = "PPFD_OUT", l_met = l_lev1, method = "time", k = 20, qc_toleave = c(0, 4), plot_graph = plot_graph)
l_lev1 <- impute(y = "PPFD_DIF", l_met = l_lev1, method = "time", k = 20, qc_toleave = c(0, 4), plot_graph = plot_graph)
# not approp for rain
...
# need error trapping for when there is no non-NA data
...
l_lev1 <- impute(y = "RG_4_1_0", l_met = l_lev1, method = "time", k = 20, qc_toleave = c(0, 4), plot_graph = plot_graph)
...
if (params$first_time_this_year) saveRDS(l_lev1, file = fname_mainmet)
# add new data to old
